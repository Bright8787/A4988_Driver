...
#define UPWARDS ENABLE
#define DOWNWARDS DISABLE
...
/*TIM2 to TIM5*/
#define TIM2_ADDR (APB1PERIPH_BASEADDR)
#define TIM3_ADDR (APB1PERIPH_BASEADDR + 0x0400U)
#define TIM4_ADDR (APB1PERIPH_BASEADDR + 0x0800U)
#define TIM5_ADDR (APB1PERIPH_BASEADDR + 0x0C00U)
...
#define pTIM2 ((TIM_RegDef_t *)TIM2_ADDR)
#define pTIM3 ((TIM_RegDef_t *)TIM3_ADDR)
#define pTIM4 ((TIM_RegDef_t *)TIM4_ADDR)
#define pTIM5 ((TIM_RegDef_t *)TIM5_ADDR)
...
#define GPIO_BASEADDR_TO_CODE(x) ((x == pGPIOA) ? 0 : (x == pGPIOB) ? 1 \
												  : (x == pGPIOC)	? 2 \
												  : (x == pGPIOD)	? 3 \
												  : (x == pGPIOE)	? 4 \
												  : (x == pGPIOF)	? 5 \
...
/*Clock Disable for TIMx peripherals*/
...
#include "../../Driver/Inc/stm32f446xx_Timer_driver.h"
